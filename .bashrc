...
#alias yt='youtube-dl --external-downloader=aria2c --external-downloader-args "--file-allocation=falloc --min-split-size=1M --split=16 --max-connection-per-server=16"'
